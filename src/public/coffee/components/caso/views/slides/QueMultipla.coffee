define [], ->
  ...
  class SlideQueMultipla extends Marionette.ItemView
    ...
    template: (data)->
      ...
      _.template($('script#caso-slides-queMultipla').html()) data
    ...
    onRender:() ->
      @ui.btnResp.addClass('disabled btn-default').text('Selecione para responder')
