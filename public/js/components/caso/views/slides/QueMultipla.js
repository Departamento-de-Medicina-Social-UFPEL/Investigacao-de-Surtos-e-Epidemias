...
define([], function() {
  ...
  SlideQueMultipla = (function(_super) {
    ...
    SlideQueMultipla.prototype.corrige = function() {
      var acertoBadge, acertos, azul, badge, conceito, corr, desempenho, div, ico, media, opcoes, resp, salvaResposta, score, scoreAtu, self, strConceito, tipo, totalScore, verde, vermelho, _ref;
      self = this;
