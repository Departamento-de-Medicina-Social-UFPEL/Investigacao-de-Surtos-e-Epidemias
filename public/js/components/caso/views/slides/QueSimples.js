...
define([], function() {
  ...
  SlideQueSimples = (function() {
    class SlideQueSimples extends Marionette.ItemView {
      ...
      corrige() {
        var acertoBadge, acertou, azul, badge, conceito, corr, div, ico, labelOpcaoCorr, labelOpcaoMar, media, resp, salvaResposta, score, scoreAtu, self, strConceito, tipo, totalScore, verde, vermelho;
        self = this;
