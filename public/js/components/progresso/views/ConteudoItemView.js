...
define(['./ErrorView'], function(ErrorView) {
  ...
  ConteudoView = (function(_super) {
    ...
    ConteudoView.prototype.inscreva = function() {
      return App.appRouter.navigate('#comp/cadastro', {
        'trigger': true
      });
    };

    ConteudoView.prototype.trocaCor = function(evt) {
    ...
    ConteudoView.prototype.paraClick = function(evt) {
      evt.preventDefault();
      return evt.stopPropagation();
    };

    ConteudoView.prototype.verificaEnquetes = function() {
      var enquetes;
    ...
    ConteudoView.prototype.emitirCertificado = function(evt) {
    ...
    ConteudoView.prototype.emitirDesempenho = function(evt) {
      var self, url;
      self = this;
      evt.stopPropagation();
    ...
    ConteudoView.prototype.verificaInscricao = function() {
