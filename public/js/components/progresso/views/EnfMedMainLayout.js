...
define(['./ConteudoItemView', './UnidadesCollView', './ConteudosCollView', './SincronizadorView'], function(ConteudoView, UnidadesCollView, ConteudosCollView, SincronizadorView) {
  var ProgressoLayout;
  ProgressoLayout = (function(_super) {
    __extends(ProgressoLayout, _super);

    function ProgressoLayout() {
      return ProgressoLayout.__super__.constructor.apply(this, arguments);
    }

    ProgressoLayout.prototype.initialize = function() {};
    ...
    ProgressoLayout.prototype.sincroniza = function() {
    ...
    ProgressoLayout.prototype.onRender = function() {
      ...
      if (fl_integrador) {
        ...
        unidades = unidades.filter((function(_this) {
          return function(u) {
            return u.unidade;
          };
        })(this)).map(function(o) {
