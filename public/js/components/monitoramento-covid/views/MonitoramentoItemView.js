...
define(['./ModalRemoverAmostra'], function(ModalRemoverAmostra) {
  ...
  ItemView = (function(_super) {
    ...
    ItemView.prototype.getGraficoSobreposto = function(elemento, options) {
      if (!options.stacking) {
    ...
    ItemView.prototype.getGraficoLinhas = function(elemento, options) {
      return Highcharts.chart(elemento, {
        chart: {
          type: 'line'
        },
    ...
    ItemView.prototype.getGraficoPizza = function(elemento, options) {
      return Highcharts.chart(elemento, {
        chart: {
    ...
    ItemView.prototype.getGraficoPizzaDupla = function(elemento, options) {
      return Highcharts.chart(elemento, {
        chart: {
          type: 'pie'
        },
    ...
    ItemView.prototype.getGraficoBarras = function(elemento, options) {
      return Highcharts.chart(elemento, {
        chart: {
          type: 'column'
        },
  ...
  data = [
    {
      ...
      drilldown: {
        ...
        categories: ["Descartado", "Suspeita de covid-19", "Confirmado para covid-19"],
        cores: ['#A3CEA5', '#C1F0A2', '#8ED685'],
        data: [descartado, suspeita, confirmado]
      }
    }, {
      y: incompleto,
      color: colors[1],
      drilldown: {
        ...
        categories: ["Perda de seguimento", "Não encontrado na ligação", "Recusa", "Problemas na equipe"],
        cores: ['#73e5da', '#1f8ab6', '#5c77bc', '#aeb8dc'],
        data: [perdaSegmento, naoEncontradoLigacao, recusa, problemasEquipe]
      }
    }, {
      y: motivoIgnorados,
      color: colors[2],
