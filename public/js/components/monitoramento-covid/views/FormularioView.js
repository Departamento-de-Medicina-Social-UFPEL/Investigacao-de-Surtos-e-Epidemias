...
define(['../collections/Monitoramentos', '../models/Monitoramento'], function(Monitoramentos, Monitoramento) {
  var FormularioView;
  FormularioView = (function(_super) {
    __extends(FormularioView, _super);

    function FormularioView() {
      this.zeraNegativos = __bind(this.zeraNegativos, this);
      return FormularioView.__super__.constructor.apply(this, arguments);
    }

    FormularioView.prototype.initialize = function() {
      var id, l, local, user;
    ...
    FormularioView.prototype.zeraNegativos = function(e) {
      if ($(e.target).val() < 0) {
        return $(e.target).val(0);
      }
    };

    FormularioView.prototype.setIgnoradosSituacao = function() {
    ...
    FormularioView.prototype.setIgnoradosRelacao = function() {
    ...
    FormularioView.prototype.setIgnoradosMotivosEncerramento = function() {
    ...
    FormularioView.prototype.setIgnoradosMonitorados = function() {
    ...
    FormularioView.prototype.setIgnoradosMonitoradosDecimoQuarto = function() {
    ...
    FormularioView.prototype.setIgnoradosVezes = function() {
    ...
    FormularioView.prototype.removeErro = function(e) {
      return $(e.target).parent().removeClass('has-error');
    };

    FormularioView.prototype.getDados = function() {
      var dados;
      dados = {
    ...
    FormularioView.prototype.salvar = function() {
    ...
    FormularioView.prototype.limpar = function() {
      return this.$el.find('input[type=number]').val('');
    };

    FormularioView.prototype.exibeMensagens = function(msgs) {
      var text;
    ...
    FormularioView.prototype.preenche = function() {
      var id, padrao;
      padrao = '';
    ...
    FormularioView.prototype.validateDatePeriodos = function(dados, msgErros) {
    ...
    FormularioView.prototype.diasNoMes = function(mes, ano) {
      var data;
      data = new Date(ano, mes, 0);
      return data.getDate();
    };

    FormularioView.prototype.getDateInternational = function(strDate) {
      var c;
    ...
    FormularioView.prototype.getNextDate = function() {
    ...
    FormularioView.prototype.getLastDateInicio = function() {
    ...
    FormularioView.prototype.onRender = function() {
