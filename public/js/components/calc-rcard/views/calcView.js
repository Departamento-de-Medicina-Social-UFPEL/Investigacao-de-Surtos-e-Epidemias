...
define(['backbone', 'backbone.marionette'], function(Backbone, Marionette) {
  ...
  calcRiscoCardioVascularMainView = (function(_super) {
    __extends(calcRiscoCardioVascularMainView, _super);

    function calcRiscoCardioVascularMainView() {
      return calcRiscoCardioVascularMainView.__super__.constructor.apply(this, arguments);
    }

    calcRiscoCardioVascularMainView.prototype.model = new Backbone.Model;

    calcRiscoCardioVascularMainView.prototype.className = 'item calculadoras rcard';
    ...
    calcRiscoCardioVascularMainView.prototype.initialize = function() {
      this.atual = 0;
    ...
    calcRiscoCardioVascularMainView.prototype.next = function() {
    ...
    calcRiscoCardioVascularMainView.prototype.trocaPara = function(indice) {
    ...
    calcRiscoCardioVascularMainView.prototype.prev = function() {
      this.atual = this.$el.find('.item.active').data('indice');
      this.$el.find('.item.active').hide();
      this.$el.find('.item.active').removeClass('active');
      if (this.atual > 1) {
    ...
    calcRiscoCardioVascularMainView.prototype.inicio = function() {
    ...
    calcRiscoCardioVascularMainView.prototype.changeDados = function() {
      var nivel, respostas;
    ...
    calcRiscoCardioVascularMainView.prototype.exibeResultado = function(nivel) {
      var conduta, self;
    ...
    calcRiscoCardioVascularMainView.prototype.getDados = function() {
    ...
    calcRiscoCardioVascularMainView.prototype.calculaEscore = function(d) {
      var escore, nivel;
      escore = 0;
      if (d[0] >= 20 && d[0] <= 39) {
        this.indiceIdade = 0;
    ...
    calcRiscoCardioVascularMainView.prototype.calculaEscoreFeminino = function(d) {
      var escore, idade;
      escore = 0;
      if (d[6] >= 60) {
        escore += -1;
    ...
    calcRiscoCardioVascularMainView.prototype.calculaEscoreMasculino = function(d) {
      var escore, idade;
      escore = 0;
      if (d[6] >= 60) {
        escore += -1;
    ...
    calcRiscoCardioVascularMainView.prototype.getConduta = function(r) {
    ...
    calcRiscoCardioVascularMainView.prototype.onRender = function(view) {
      this.ui.item.hide();
