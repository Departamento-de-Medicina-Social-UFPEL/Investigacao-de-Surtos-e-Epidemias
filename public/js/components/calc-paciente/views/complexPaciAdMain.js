    ...
    complexidadePacienteAdMainView.prototype.tabela = [
      {
        nivel: 0,
        descricao: "Nível 0",
        processos: ["Paciente com sua capacidade funcional preservada e baixo risco de agravos à saúde, sem indicação para assistência domiciliar.",
      " Acompanhamento habitual da ESF."]
      },
      {
        nivel: 1,
        descricao: "Nível 1",
        processos: ["Visita mensal de ACS.",
      ...
      "Atendimento do técnico de enfermagem ou enfermeiro quando indicado e prescrito pela equipe (exemplo: cobertura para úlceras de membros). Acionar a Emad–1 em casos extremos, quando a necessidade de atenção superar a capacidade de oferta da ESF."]
      },
      {
        nivel: 3,
        descricao: "Nível 3",
