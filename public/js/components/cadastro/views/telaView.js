...
define(['backbone.modal', 'utils', 'uf_municipios'], function(ModalView, utils, Uf) {
  ...
  return Modal = (function(_super) {
    ...
    Modal.prototype.marcaInscritas = function() {
      var hoje, self;
      self = this;
      if (!this.user) {
        return;
    ...
    Modal.prototype.obtemOfertas = function() {
    ...
    Modal.prototype.fillForm = function() {
      var check, input, _i, _j, _len, _len1, _ref, _ref1, _results;
      ...
      _ref = ['alt_anos_vigilancia_sus', 'alt_nome_profissao', 'alt_tempo_profissao'];
    ...
    Modal.prototype.layoutAlternativoMudouProfissao = function() {
    ...
    Modal.prototype.layoutAlternativoMudouAtuacaoSus = function() {
    ...
    Modal.prototype.mostraEstagio = function() {
      this.limpaErro();
    ...
    Modal.prototype.estagio0 = function() {};

    Modal.prototype.validaEstagio0 = function() {
      var cpf;
      cpf = utils.pretty.dig(this.$el.find('#inputCpf').val());
      if (!(cpf.length === 11 && utils.valCPF(cpf))) {
    ...
    Modal.prototype.estagio2 = function() {
    ...
    Modal.prototype.validaEstagio2 = function(silent) {
      var data, mensagemErro, _ref;
      if (silent == null) {
        silent = false;
      }
      data = {};
      ...
      if ($('[name=alt_atuou_vigilancia_sus]:checked').length === 0) {
        ...
        if (((_ref = data.alt_atuou_vigilancia_sus) === 'S' || _ref === 'A') && $('[name=alt_anos_vigilancia_sus]').val() === '') {
    ...
    Modal.prototype.verificaIntegracao = function() {
    ...
    Modal.prototype.normalDateNumber = function(evt) {
      var str;
    ...
    Modal.prototype.validaEstagio1 = function() {
      var cpf;
    ...
    Modal.prototype.estagio1 = function(evt) {
      var cpf, local, progresso, self, socket;
      self = this;
      this.$el.find('.btn-avancar').attr('disabled', true);
      $('.submit-form').hide();
      $('.btn-voltar').hide();
      $('.btn-avancar').show();
      ...
      return socket.emit('getuser', {
        ...
        var c, erroServidor, mensagemErro, u, _i, _len, _ref;
    ...
    Modal.prototype.limpaErro = function() {
      return $('.alert').empty();
    };
    ...
    Modal.prototype.temNucleo = function(evt) {
      var nc;
    ...
    Modal.prototype.prettyNome = function(evt) {
      var str;
      this.hadFocus = $(evt.target);
      str = $(evt.target).val();
    ...
    Modal.prototype.normalCpf = function(evt) {
      var str;
      this.hadFocus = $(evt.target);
      str = $(evt.target).val();
    ...
    Modal.prototype.normalEmail = function(evt) {
      var str;
      this.hadFocus = $(evt.target);
      str = $(evt.target).val();
      str = str.toLowerCase();
    ...
    Modal.prototype.montaComboEstados = function() {
    ...
    Modal.prototype.obtemMunicipios = function() {
      var cit, cits, estado, k, muniSel, opt, uf, uma, _i, _len, _ref;
    ...
    Modal.prototype.muni_ibge = function() {
      var ibge;
