  ...
  calCovidMainView = (function() {
    class calCovidMainView extends Marionette.ItemView {
      ...
      calculaCategoria(dados) {
        ...
        if (this.ui.tem11anos.filter(':checked').val() === '1') { //11 ou mais
          //sg suspeito  
      ...
      calculaEscore() {
        ...
        if (categoria === 1) {
          ...
          if (dados[9] === '0') { //contato proximo não
    ...
    calCovidMainView.prototype.tabela = [
      ...
      },
      {
        ...
        nr_dias: 10,
        processos: ["Suspensão do isolamento é condicionada a estar há 24 horas sem febre sem uso de antitérmicos e ter remissão dos sintomas respiratórios.",
      ...
      },
      {
        ...
        nr_dias: 10,
        nr_dias_pcr: 8, // (por 8 dias a partir do início dos sintomas)
        processos: ["A realização do teste de antígeno fora do prazo preconizado (a partir do 8º dia do início dos sintomas) aumenta a probabilidade de resultados falso negativos. ",
      ...
      },
      {
        ...
        isolamento: true,
        nr_dias: 10,
        processos: ["A realização do teste RT-PCR fora do prazo preconizado (a partir do 9º dia do início dos sintomas) aumenta a probabilidade de resultados falso negativos.",
      ...
      },
      {
        ...
        nr_dias: 20,
        nr_dias_pcr: 14, // (por 8 dias a partir do início dos sintomas)
        processos: ["A realização do teste de antígeno fora do prazo preconizado (a partir do 9º dia do início dos sintomas) aumenta a probabilidade de resultados falso negativos. ",
      "Suspensão do isolamento é condicionada a estar há 24 horas sem febre sem uso de antitérmicos e ter remissão dos sintomas respiratórios.",
      "Indivíduos gravemente imunossuprimidos: Realizar isolamento por 20 dias a partir da data do início dos sintomas. A critério médico, pode ser requerido, nesta população, a apresentação de  RT-PCR não detectável para a descontinuidade do isolamento.",
      "Identificar, Rastrear, Monitorar e Isolar contatos próximos."]
      },
      {
        ...
        nr_dias_pcr: 14, // (por 8 dias a partir do início dos sintomas)
        nr_dias_antigeno: 7, // (por 10 dias a partir do início dos sintomas)
        processos: [" A realização do teste RT-PCR fora do prazo preconizado (a partir do 15º dia do início dos sintomas) aumenta a probabilidade de resultados falso negativos.",
      "A realização do teste de antígeno fora do prazo preconizado (a partir do 8º dia do início dos sintomas) aumenta a probabilidade de resultados falso negativos. ",
      "Suspensão do isolamento é condicionada a estar há 24 horas sem febre sem uso de antitérmicos e ter remissão dos sintomas respiratórios.",
      "Indivíduos gravemente imunossuprimidos: Realizar isolamento por 20 dias a partir da data do início dos sintomas. A critério médico, pode ser requerido, nesta população, a apresentação de  RT-PCR não detectável para a descontinuidade do isolamento.",
      "Identificar, Rastrear, Monitorar e Isolar contatos próximos."]
      ...
      },
      {
        ...
        descricao: "SG não especificada, testes não reagente/não detectável no prazo",
        isolamento: true,
        processos: ["O teste de antígeno é menos sensível que o RT-PCR, assim se for necessário suspender o isolamento é recomendado confirmar o resultado através do teste RT-PCR / RT-Lamp.",
      "Suspensão do isolamento é condicionada a estar há 24 horas sem febre sem uso de antitérmicos e ter remissão dos sintomas respiratórios.",
      "Indivíduos gravemente imunossuprimidos: Realizar isolamento por 20 dias a partir da data do início dos sintomas. A critério médico, pode ser requerido, nesta população, a apresentação de  RT-PCR não detectável para a descontinuidade do isolamento.",
      "Monitorar Caso Suspeito preferencialmente a partir das primeiras 48 horas após a notificação do caso, no mínimo a cada 2 dias, por 14 dias e obrigatoriamente no 14º dia.",
      "Identificar, Rastrear, Monitorar e Isolar contatos próximos."]
      },
      {
        ...
        isolamento: false,
        processos: ["Caso um primeiro teste de RT-PCR tenha resultado negativo, um segundo teste RT-PCR, preferencialmente com material de via aérea baixa, deve ser realizado 48 horas após o primeiro. Sendo os dois negativos, o paciente poderá ser retirado da precaução para Covid-19. ",
      "Suspensão do isolamento é condicionada a estar há 24 horas sem febre sem uso de antitérmicos e ter remissão dos sintomas respiratórios."]
      },
      {
        nivel: 61,
      ...
      },
      {
        ...
        nr_dias: 10,
        processos: ["Teste realizado fora do período recomendado, assim o resultado tem maior probabilidade de ser falso negativo.",
      "Suspensão do isolamento é condicionada a estar há 24 horas sem febre sem uso de antitérmicos e ter remissão dos sintomas respiratórios.",
      "Indivíduos gravemente imunossuprimidos: Realizar isolamento por 20 dias a partir da data do início dos sintomas. A critério médico, pode ser requerido, nesta população, a apresentação de  RT-PCR não detectável para a descontinuidade do isolamento.",
      "Monitorar caso suspeito preferencialmente a partir das primeiras 48 horas após a notificação do caso, no mínimo a cada 2 dias, por 14 dias e obrigatoriamente no 14º dia.",
      "Identificar, Rastrear, Monitorar e Isolar contatos próximos."]
      ...
      },
      {
        ...
        nr_dias: 10,
        processos: ["Monitorar caso confirmado preferencialmente a partir das primeiras 48 horas após a notificação do caso, no mínimo a cada 2 dias, por 14 dias e obrigatoriamente no 14º dia. ",
      "Identificar, Rastrear, Monitorar e Isolar contatos próximos."]
      },
      {
        nivel: 11,
      ...
      },
      {
        ...
        isolamento: true, //(por 10 dias a partir da data do último contato com o caso confirmado).
        nr_dias: 10,
        processos: ["Teste realizado fora do período recomendado.",
