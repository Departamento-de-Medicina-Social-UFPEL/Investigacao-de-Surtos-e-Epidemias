...
define(['backbone', 'backbone.marionette'], function(Backbone, Marionette) {
  var sobreCuidaMain;
  sobreCuidaMain = (function(_super) {
    __extends(sobreCuidaMain, _super);

    function sobreCuidaMain() {
      return sobreCuidaMain.__super__.constructor.apply(this, arguments);
    }

    sobreCuidaMain.prototype.model = new Backbone.Model;

    sobreCuidaMain.prototype.className = 'item calculadoras sobreCuida';

    sobreCuidaMain.prototype.template = "#calc-sobrecarga-main";

    sobreCuidaMain.prototype.ui = {
      'resp': '.resposta',
      'item': '.item',
      'next': '#next',
      'li': 'li',
    ...
    sobreCuidaMain.prototype.events = {
      'click @ui.next': 'next',
    ...
    sobreCuidaMain.prototype.next = function() {
      var atual;
      console.log('next');
    ...
    sobreCuidaMain.prototype.prev = function() {
      var atual;
      atual = this.$el.find('.item.active').data('indice');
    ...
    sobreCuidaMain.prototype.inicio = function() {
      console.log('inicio');
    ...
    sobreCuidaMain.prototype.changeDados = function() {
      var respostas, valor;
    ...
    sobreCuidaMain.prototype.getDados = function() {
    ...
    sobreCuidaMain.prototype.calculaEscore = function(d) {
      var escore, item;
      escore = 0;
      console.log(d, 'd');
      for (item in d) {
    ...
    sobreCuidaMain.prototype.onRender = function(view) {
      this.ui.item.hide();
