...
define(['../collections/SlidesColl', './SlidesColl', './Introbox', 'utils'], function(SlidesColl, SlidesCollView, IntroboxView, utils) {
  ...
  CasoView = (function(_super) {
    ...
    CasoView.prototype.next = function() {
    ...
    CasoView.prototype.trocaPara = function(indice) {
      this.atual = indice;
    ...
    CasoView.prototype.prev = function() {
      if (this.ui.next.hasClass('disabled')) {
        return;
      }
      this.atual = this.$el.find('li.active>.link-item').data('indice');
    ...
    CasoView.prototype.avancou = function(indice) {
      var salvaResposta;
    ...
    CasoView.prototype.vaiParaOndeEstava = function() {};

    CasoView.prototype.inicio = function() {
      console.log('inicio');
